# Release-day checklist — v0.1.0 (Method v2 reference implementation)
...
- [ ] README: uncomment the DOI badge with the **concept DOI**; `CITATION.cff`:
      uncomment `doi:`. Commit (this lands in v0.1.1+/v0.2.0 — expected and fine).
- [ ] Old prototype repo: private (or archived), with its README pointing here.

## v0.2.0 (the report release)
...
- [ ] Tag v0.2.0 → new version DOI, same concept DOI.
