 ...
 * Unknown/malformed versions (including pre-release suffixes like "1.2.3-beta")
 * compare as 0.0.0 (older than everything real) — the regex is anchored at both
 * ends so a prefix match can never pass as a valid version. */
