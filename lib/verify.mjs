...
// whose extension IS a real file extension (so the allow-list below can't catch
// them). `node.js`/`vue.js` (ext `js`) and `console.log`/`this.state` all need
// this explicit deny-list.
