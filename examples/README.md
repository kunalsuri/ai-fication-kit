...
The kit scaffolds the agent instructions, custom slash commands, subagents, and the provenance-tracked `ai/` folder. You can explore a frozen post-cold-start snapshot in [legacy-calculator/example-output/](legacy-calculator/example-output) to see exactly what is generated:
