...
| W-009 | 2026-07-05 | docs | README + docs staleness sync: the workflow-command roster lagged the code (10 universal commands now, not 8 — `/fix-bug` and `/review-change` were missing) and only the `add-feature` skill was named where `fix-bug` also ships; `docs/README.md` hub still said "all 8" CLI commands when `docs/CLI-REFERENCE.md` documents 12 | — (surgical doc drift fix, no code change) | — | — | — | branch claude/update-readme-docs-7glmi7 | `README.md`, `docs/README.md`, `docs/FAQ.md` | shipped | [inferred] |
