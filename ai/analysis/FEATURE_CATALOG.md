...
>
> **Cold-start snapshot — 2026-06-17** (commit `<commit-hash>`), once generated.
>
...
Depending on the complexity of ai-fication-kit, the catalog can live in a single file or be split to reduce token context overhead:
