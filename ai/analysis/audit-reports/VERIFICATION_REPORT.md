...
> Generated mechanically by ai-fication-kit `verify` on 2026-07-05.
...
|---|---|---|
| confirmed | 288 | claim found on disk |
...
288 confirmed claim(s) — full list in VERIFICATION_MANIFEST.json.
