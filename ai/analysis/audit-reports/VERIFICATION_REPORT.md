...
> Generated mechanically by ai-fication-kit `verify` on 2026-07-04.
...
|---|---|---|
| confirmed | 186 | claim found on disk |
...
186 confirmed claim(s) — full list in VERIFICATION_MANIFEST.json.
