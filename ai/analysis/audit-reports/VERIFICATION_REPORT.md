...
> Generated mechanically by ai-fication-kit `verify` on 2026-06-30.
...
|---|---|---|
| confirmed | 116 | claim found on disk |
...
116 confirmed claim(s) — full list in VERIFICATION_MANIFEST.json.
