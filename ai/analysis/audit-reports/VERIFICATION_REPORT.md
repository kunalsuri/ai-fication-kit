...
> Generated mechanically by ai-fication-kit `verify` on 2026-07-29.
...
|---|---|---|
| confirmed | 387 | claim found on disk |
...
387 confirmed claim(s) — full list in VERIFICATION_MANIFEST.json.
