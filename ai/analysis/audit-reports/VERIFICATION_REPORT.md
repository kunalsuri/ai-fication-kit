...
> Generated mechanically by ai-fication-kit `verify` on 2026-07-11.
...
|---|---|---|
| confirmed | 352 | claim found on disk |
...
352 confirmed claim(s) — full list in VERIFICATION_MANIFEST.json.
